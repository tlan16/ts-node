This is a fork of the official ts-node git repository. 

This is aiming to resolve:

- official ts-node is regularly maintained, but not releasing its latest change in a long time.
- support tsconfig extending from multiple file.
